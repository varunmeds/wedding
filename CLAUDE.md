...
- **`Ceremonies`** renders the three Kodava (Codava) wedding ceremonies from `content.js`'s `ceremonies` export (Oorkuduva, Muhurtha, Ganga Pooja). This is a Kodava wedding with no priest; the rites are led by family elders.
